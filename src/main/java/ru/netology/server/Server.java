...
//                awaitConnection(socket);
    ...
    public void awaitConnection(Socket socket) {
        try (
            ...
            System.out.println("Getting QUERY params");
            System.out.println(request.getQueryParams());
            System.out.println();

            System.out.println("Getting QUERY param \"login\"");
            System.out.println(request.getQueryParam("login"));
            System.out.println();

            System.out.println("Getting POST params");
            System.out.println(request.getPostParams());
            System.out.println();

            System.out.println("Getting POST param \"login\"");
    ...
    public Request parseRequest(BufferedReader in, Request request) throws IOException {
        ...
        request.setBody(URLDecoder.decode(bodyBuilder.toString(), StandardCharsets.UTF_8));
